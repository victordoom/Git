...
namespace WebAdmin.Controllers
{
    ...
    public class SegUsuariosController : Controller
    {
        ...
        [HttpPost]
        //public async Task<IActionResult> Login2([Bind("Login,WebPassword")]SegUsuarios usuarios)
        //{

        //    var segLoginData =  _context.SegUsuarios.Where(u => u.Login == usuarios.Login ).FirstOrDefault();

        //    if (segLoginData != null )
        //    {
     
        //        //var hashCode = segLoginData.VCode;
    
        //        //var encodingPasswordString = HelperClass.Helper.EncodePassword(usuarios.WebPassword, hashCode);
    
        //        //var user2 = await _context.SegUsuarios.AnyAsync(u => u.Login == usuarios.Login && u.WebPassword.Equals(encodingPasswordString));
